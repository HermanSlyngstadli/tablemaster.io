...
import ankreal from '../assets/ankreal.png'
...
export const AnkrealMap = () => {
    ...
    const bounds = new LatLngBounds(
        ...
        [1000, 1600] // Top-right corner (adjust based on image size)
    )
    ...
    return (
        <MapContainer center={[500, 500]} zoom={1} crs={L.CRS.Simple} scrollWheelZoom={true}>
            <ImageOverlay url={ankreal} bounds={bounds} />
